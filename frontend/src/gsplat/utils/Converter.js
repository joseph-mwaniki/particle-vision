...
class Converter {
    ...
    static SplatToPLY(buffer, vertexCount) {
        ...
        for (let i = 0; i < vertexCount; i++) {
            ...
            let q = new Quaternion((u_buffer[32 * i + 28 + 1] - 128) / 128, (u_buffer[32 * i + 28 + 2] - 128) / 128, (u_buffer[32 * i + 28 + 3] - 128) / 128, (u_buffer[32 * i + 28 + 0] - 128) / 128);
            q = q.normalize();
            const rot0 = q.w;
            const rot1 = q.x;
            const rot2 = q.y;
