...
class Camera extends Object3D {
    ...
    constructor(camera = undefined) {
        ...
        this.screenPointToRay = (x, y) => {
            ...
            const worldSpacePosition = new Vector3(worldSpaceCoords.x / worldSpaceCoords.w, worldSpaceCoords.y / worldSpaceCoords.w, worldSpaceCoords.z / worldSpaceCoords.w);
