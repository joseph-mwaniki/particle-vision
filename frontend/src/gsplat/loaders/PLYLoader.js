...
class PLYLoader {
    static async LoadAsync(url, scene, onProgress, format = "", useCache = false) {
    ...
    static async LoadFromFileAsync(file, scene, onProgress, format = "") {
        const reader = new FileReader();
        let splat = new Splat();
        reader.onload = (e) => {
            splat = this.LoadFromArrayBuffer(e.target.result, scene, format);
        };
        reader.onprogress = (e) => {
    ...
    static LoadFromArrayBuffer(arrayBuffer, scene, format = "") {
    ...
    static _ParsePLYBuffer(inputBuffer, format) {
