...
class VideoRenderProgram extends ShaderProgram {
    ...
    constructor(renderer, passes = []) {
        ...
        this._initialize = () => {
            ...
            u_time = gl.getUniformLocation(this.program, "time");
            ...
            gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA32UI, this._renderData.width, this._renderData.height, 0, gl.RGBA_INTEGER, gl.UNSIGNED_INT, this._renderData.data);
